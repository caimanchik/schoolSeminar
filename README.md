...
Задания находятся в папке ```lections/lection + номер_лекции```
...
## Пример
Треьуется выполнить 1 задание 1 лекции

Открываем в проводнике VSCode файл по пути ``` lections/lection1/1.ts ```
